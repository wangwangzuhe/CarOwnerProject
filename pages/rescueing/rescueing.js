...
app.vaildPage({
  ...
  realtimedistace() {
    ...
    var distace = util.getFlatternDistance(_this.data.markers[0].latitude, _this.data.markers[0].longitude, _this.data.markers[1].latitude, _this.data.markers[1].longitude)
