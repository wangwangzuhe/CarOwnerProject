...
app.vaildPage({
    ...
    bindrespeed(e) {
        ...
        this.printxing(this.data.respeed, id, function (respeed) {
            this.setData({
                respeed: respeed,
                respeedxing: id
            });
        ...
        var id = parseInt(e.currentTarget.dataset.id);
        this.printxing(this.data.servattri, id, function (servattri) {
            this.setData({
                servattri: servattri,
                servattrixing: id
            });
        ...
        this.printxing(this.data.realfun, id, function (realfun) {
            this.setData({
                realfun: realfun,
                realfunxing: id
            });
